...
struct TerminalSessionAttachmentProbe {
    ...
    private func ghosttySnapshots() throws -> [GhosttyTerminalSnapshot] {
        let script = TerminalProbeSupport.ghosttyEnumerationScript
    ...
    private func terminalSnapshots() throws -> [TerminalTabSnapshot] {
        let script = TerminalProbeSupport.terminalEnumerationScript
    ...
    static func defaultAppleScriptRunner(script: String) throws -> String {
        try TerminalProbeSupport.runOSAScript(
            ...
            errorDomain: "TerminalSessionAttachmentProbe"
        )
    }
}
